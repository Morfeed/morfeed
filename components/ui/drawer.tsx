...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={cn("text-sm text-balance text-neutral-foreground", className)}
      {...props}
    />
  )
}
